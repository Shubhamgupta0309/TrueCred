    ...
    >
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-4">
          <div className="w-16 h-16 bg-gradient-to-br from-purple-600 to-teal-500 rounded-full flex items-center justify-center text-white">
          ...
          <div>
            ...
            <div className="mt-1">
              <span className="bg-teal-100 text-teal-700 text-xs font-semibold px-2 py-1 rounded-full">{user.role}</span>
            </div>
          </div>
        </div>
