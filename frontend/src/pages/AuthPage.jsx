        ...
        >
          <div className="bg-slate-950/40 backdrop-blur-xl rounded-2xl shadow-2xl shadow-cyan-500/10 overflow-hidden border border-cyan-500/20">
            ...
            <div className="px-8 py-6">
              ...
              >
                {isSubmitting ? (
                  <div className="flex items-center justify-center">
                    <svg className="animate-spin -ml-1 mr-3 h-5 w-5 text-cyan-100" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
              ...
              {!isLogin && (
                <div className="mt-4 bg-cyan-950/30 border-l-4 border-cyan-500 p-4">
                  <div className="flex">
                    <div className="flex-shrink-0">
                      <svg className="h-5 w-5 text-cyan-300" viewBox="0 0 20 20" fill="currentColor">
